...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'peony' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'peony' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'peony' ),
		'cyrillic'     => __( 'Cyrillic', 'peony' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'peony' ),
		'devanagari'   => __( 'Devanagari', 'peony' ),
		'greek'        => __( 'Greek', 'peony' ),
		'greek-ext'    => __( 'Greek Extended', 'peony' ),
		'khmer'        => __( 'Khmer', 'peony' ),
		'latin'        => __( 'Latin', 'peony' ),
		'latin-ext'    => __( 'Latin Extended', 'peony' ),
		'vietnamese'   => __( 'Vietnamese', 'peony' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'peony' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'peony' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'peony' ),
