...
<article id="post-<?php the_ID(); ?>" <?php post_class('col-md-4 col-sm-4 grid grid_2_column grid_3_column'); ?>>
		...
		<div class="out-thumb col-md-12">
			<header class="entry-header">
				...
				<div class="postedon"><?php ihbp_posted_on(); ?></div>
				<span class="entry-excerpt"><?php the_excerpt() ?></span>
				<span class="readmore"><a class="hvr-underline-from-center" href="<?php the_permalink() ?>"><?php _e('Read More','ih-business-pro'); ?></a></span>
			</header><!-- .entry-header -->
		</div><!--.out-thumb-->
