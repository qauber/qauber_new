...
<div id="posts-content"  class="container" >
   ...
   <section id="posts-content"  class="container" >
      <h2 class="section-heading"><?php esc_html_e( 'Nothing Found', 'incubator' ); ?></h2>
      <span class="separator"></span>
      <?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
      <p  class="section-subheading"><?php printf( esc_html__( 'Ready to publish your first post?', 'incubator' ), esc_url( admin_url( 'post-new.php' ) ) ); ?></p>
      <?php elseif ( is_search() ) : ?>
      <p  class="section-subheading"><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again using different keywords.', 'incubator' ); ?></p>
      <?php get_search_form(); ?>
      <?php else : ?>
      <p  class="section-subheading"><?php esc_html_e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'incubator' ); ?></p>
      <?php get_search_form(); ?>
      <?php endif; ?>
   </section>
   <?php endif; ?>
