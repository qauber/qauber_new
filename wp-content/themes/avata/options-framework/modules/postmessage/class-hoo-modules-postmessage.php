...
class Hoo_Modules_PostMessage {
	...
	public function postmessage() {
		...
		wp_enqueue_script( 'hoo_auto_postmessage', trailingslashit( Hoo::$url ) . 'modules/postmessage/postmessage.js', array( 'jquery', 'customize-preview' ), false, true );
		$fields = Hoo::$fields;
		...
		wp_add_inline_script( 'hoo_auto_postmessage', $this->script, 'after' );
	...
	protected function script( $args ) {
		...
		// The style ID.
		$style_id = 'hoo-postmessage-' . str_replace( array( '[', ']' ), '', $args['settings'] );
