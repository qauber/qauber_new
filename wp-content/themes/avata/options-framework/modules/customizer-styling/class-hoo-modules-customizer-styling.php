 ...
 */
class Hoo_Modules_Customizer_Styling {
	...
	public function custom_css() {
		...
		if ( $back ) {
			...
			$elements = array(
				'.customize-control-hoo-background .background-attachment .buttonset .switch-label',
				'.customize-control-hoo-background .background-size .buttonset .switch-label',
				'.customize-control-hoo-radio-buttonset .buttonset .switch-label',
			);
			$css .= implode( ',', $elements ) . "{color:{$text_on_back};}";
			...
			$css .= ".customize-control-hoo-slider input[type=range]::-webkit-slider-thumb{background-color:{$accent};}";
			$css .= ".customize-control-hoo-slider input[type=range]::-moz-range-thumb{background-color:{$accent};}";
			$css .= ".customize-control-hoo-slider input[type=range]::-ms-thumb{background-color:{$accent};}";

			$css .= ".customize-control-hoo-slider input[type=range]{background:{$border_on_back};}";
			...
			$css .= ".hoo-reset-section .dashicons{color:{$back_on_back};}";
		...
		if ( $accent ) {
			...
			$elements = array(
				'.customize-control-hoo-radio-buttonset .buttonset .switch-input:checked + .switch-label',
				'.customize-control-hoo-background .background-attachment .buttonset .switch-input:checked + .switch-label',
				'.customize-control-hoo-background .background-size .buttonset .switch-input:checked + .switch-label',
			);
