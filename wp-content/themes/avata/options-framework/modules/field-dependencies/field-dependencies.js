		...
		switch ( operator ) {
			...
			case 'in':
				if ( _.isObject( value2 ) ) {
					...
					window.hooControlDependencies[ extras[0] ][ extras[1] ] = false;
					_.each( value2, function( subValue ) {
						if ( value1 === subValue ) {
							window.hooControlDependencies[ extras[0] ][ extras[1] ] = true;
						}
					});
					return window.hooControlDependencies[ extras[0] ][ extras[1] ];
