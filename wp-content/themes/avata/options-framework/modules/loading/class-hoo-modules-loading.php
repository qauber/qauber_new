...
class Hoo_Modules_Loading {
	...
	public function add_loader_to_footer() {
		?>
		<div class="hoo-customizer-loading-wrapper">
			<span class="hoo-customizer-loading"></span>
		</div>
		<?php
	}
	...
	public function add_loader_styles_to_header() {
		...
		<style>
			...
			.hoo-customizer-loading-wrapper {
				width: 100%;
				height: 100%;
				position: fixed;
				top: 0;
				...
				background-image: url("<?php echo esc_url_raw( Hoo::$url ); ?>/assets/images/hoo-logo.svg");
				background-repeat: no-repeat;
				background-position: center center;
			}
			body.wp-customizer-unloading .hoo-customizer-loading-wrapper {
				display: block;
				opacity: 1;
			}
			.hoo-customizer-loading-wrapper .hoo-customizer-loading {
				position: absolute;
				width: 60px;
				height: 60px;
				top: 50%;
