jQuery( document ).ready( function() {
	...
	if ( ! _.isUndefined( hooIcons.section ) ) {

		// Parse sections and add icons.
		_.each( hooIcons.section, function( icon, sectionID ) {
	...
	if ( ! _.isUndefined( hooIcons.panel ) ) {

		_.each( hooIcons.panel, function( icon, panelID ) {
