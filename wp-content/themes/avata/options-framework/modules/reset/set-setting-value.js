			...
			switch ( subControl.type ) {
				...
				case 'hoo-background':
					if ( ! _.isUndefined( value['background-color'] ) ) {
						$this.setColorPicker( $this.findElement( setting, '.hoo-color-control' ), value['background-color'] );
					}
				...
				case 'hoo-color':
					$this.setColorPicker( $this.findElement( setting, '.hoo-color-control' ), value );
					break;
				...
				case 'hoo-radio-buttonset':
				case 'hoo-radio-image':
				case 'hoo-radio':
				case 'hoo-dashicons':
				case 'hoo-color-palette':
				case 'hoo-palette':
				...
				case 'hoo-typography':
					...
					if ( ! _.isUndefined( value.color ) ) {
						$this.setColorPicker( $this.findElement( setting, '.hoo-color-control' ), value.color );
					}
					valueJSON = JSON.stringify( value ).replace( /'/g, '&#39' );
