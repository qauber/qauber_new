 ...
 * Field overrides.
 */
class Hoo_Field_Typography extends Hoo_Field {
		...
		foreach ( $value as $key => $val ) {
			switch ( $key ) {
				...
				case 'subset':
					...
					$valid_subsets = Hoo_Fonts::get_google_font_subsets();
					$subsets_ok = array();
				...
				case 'word-spacing':
				case 'line-height':
					$value[ $key ] = Hoo_Sanitize_Values::css_dimension( $val );
					break;
				case 'text-align':
