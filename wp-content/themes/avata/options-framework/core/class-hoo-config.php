...
/**
 * The Hoo_Config object
 */
final class Hoo_Config {
	...
	/**
	 * Set to true if you want to completely disable any Hoo-generated CSS.
	 *
	 * @access protected
	 * @var bool
	 */
	 ...
	 * @access private
	 *
	 * @param string $config_id @see Hoo_Config::get_instance().
	 * @param array  $args      @see Hoo_Config::get_instance().
	 */
	private function __construct( $config_id = 'global', $args = array() ) {
		...
		// Apply any options-framework/config global filters.
		$defaults = apply_filters( 'options-framework/config', $defaults );
