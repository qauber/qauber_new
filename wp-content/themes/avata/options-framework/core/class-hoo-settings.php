...
class Hoo_Settings {
	...
	/**
	 * Creates a new Hoo_Settings object.
	 * Class constructor.
	 *
	 * @access public
	 * @param array $args The field definition as sanitized in Hoo_Field.
	 */
	...
	final private function set_setting_types() {
		...
		$this->setting_types = apply_filters( 'options-framework/setting_types', array(
			...
			'repeater'    => 'Hoo_Settings_Repeater_Setting',
			'user_meta'   => 'Hoo_Setting_User_Meta',
			'site_option' => 'Hoo_Setting_Site_Option',
		) );
