...
class Hoo_Sanitize_Values {
	...
	public static function __callStatic( $name, $arguments ) {
		error_log( "Hoo_Sanitize_Values::$name does not exist" );
		return $arguments;
	}
	 ...
	 *
	 * Deprecated. Use Hoo_Field_Checkbox::sanitize() instead.
	 *
	 * @static
	 * @access public
	 * @see Hoo_Field_Checkbox::sanitize()
	 * @param bool|string $value Whether the checkbox is checked.
	 * @return bool Whether the checkbox is checked.
	 */
	public static function checkbox( $value ) {
		$obj = new Hoo_Field_Checkbox();
