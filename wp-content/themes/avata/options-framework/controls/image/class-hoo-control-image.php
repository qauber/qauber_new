 ...
 */
class Hoo_Control_Image extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		if ( ! class_exists( 'Hoo_Custom_Build' ) || ! Hoo_Custom_Build::is_custom_build() ) {
			wp_enqueue_script( 'hoo-image', trailingslashit( Hoo::$url ) . 'controls/image/image.js', array( 'jquery', 'customize-base' ) );
			wp_enqueue_style( 'hoo-image', trailingslashit( Hoo::$url ) . 'controls/image/image.css', null );
		}
	}
