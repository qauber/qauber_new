 ...
 */
class Hoo_Control_Switch extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		if ( ! class_exists( 'Hoo_Custom_Build' ) || ! Hoo_Custom_Build::is_custom_build() ) {
			wp_enqueue_script( 'hoo-switch', trailingslashit( Hoo::$url ) . 'controls/switch/switch.js', array( 'jquery', 'customize-base' ), false, true );
			wp_enqueue_style( 'hoo-switch-css', trailingslashit( Hoo::$url ) . 'controls/switch/switch.css', null );
		}
	}
