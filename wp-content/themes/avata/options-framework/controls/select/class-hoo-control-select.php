 ...
 * Select control.
 */
class Hoo_Control_Select extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		if ( ! class_exists( 'Hoo_Custom_Build' ) || ! Hoo_Custom_Build::is_custom_build() ) {
			wp_enqueue_script( 'hoo-select', trailingslashit( Hoo::$url ) . 'controls/select/select.js', array( 'jquery', 'customize-base', 'select2', 'jquery-ui-sortable' ), false, true );
			wp_enqueue_style( 'hoo-select-css', trailingslashit( Hoo::$url ) . 'controls/select/select.css', null );
		}
