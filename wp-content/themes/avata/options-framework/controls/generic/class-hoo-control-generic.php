 ...
 */
class Hoo_Control_Generic extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		if ( ! class_exists( 'Hoo_Custom_Build' ) || ! Hoo_Custom_Build::is_custom_build() ) {
			wp_enqueue_script( 'hoo-generic', trailingslashit( Hoo::$url ) . 'controls/generic/generic.js', array( 'jquery', 'customize-base' ), false, true );
			wp_enqueue_style( 'hoo-generic-css', trailingslashit( Hoo::$url ) . 'controls/generic/generic.css', null );
		}
	}
