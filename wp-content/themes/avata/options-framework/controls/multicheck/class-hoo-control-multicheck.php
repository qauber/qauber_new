 ...
 */
class Hoo_Control_MultiCheck extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		if ( ! class_exists( 'Hoo_Custom_Build' ) || ! Hoo_Custom_Build::is_custom_build() ) {
			wp_enqueue_script( 'hoo-multicheck', trailingslashit( Hoo::$url ) . 'controls/multicheck/multicheck.js', array( 'jquery', 'customize-base' ), false, true );
			wp_enqueue_style( 'hoo-multicheck-css', trailingslashit( Hoo::$url ) . 'controls/multicheck/multicheck.css', null );
		}
	}
