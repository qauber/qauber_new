 ...
 */
class Hoo_Control_Dashicons extends WP_Customize_Control {
	...
	public function to_json() {
		...
		$this->json['icons'] = Hoo_Helper::get_dashicons();
	}
	...
	public function enqueue() {
		...
		if ( ! class_exists( 'Hoo_Custom_Build' ) || ! Hoo_Custom_Build::is_custom_build() ) {
			wp_enqueue_script( 'hoo-dashicons', trailingslashit( Hoo::$url ) . 'controls/dashicons/dashicons.js', array( 'jquery', 'customize-base' ), false, true );
			wp_enqueue_style( 'hoo-dashicons-css', trailingslashit( Hoo::$url ) . 'controls/dashicons/dashicons.css', null );
		}
	}
