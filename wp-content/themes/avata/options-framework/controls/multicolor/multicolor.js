wp.customize.controlConstructor['hoo-multicolor'] = wp.customize.Control.extend({
	...
	initHooControl: function() {
		...
		function hooMulticolorChangeHandler( control, value, subSetting ) {
		...
		while ( i < Object.keys( colors ).length ) {
			...
			hooMulticolorChangeHandler( this, value, keys[ i ] );
