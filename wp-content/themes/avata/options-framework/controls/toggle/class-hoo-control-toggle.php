 ...
 */
class Hoo_Control_Toggle extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		if ( ! class_exists( 'Hoo_Custom_Build' ) || ! Hoo_Custom_Build::is_custom_build() ) {
			wp_enqueue_script( 'hoo-toggle', trailingslashit( Hoo::$url ) . 'controls/toggle/toggle.js', array( 'jquery', 'customize-base' ), false, true );
			wp_enqueue_style( 'hoo-toggle-css', trailingslashit( Hoo::$url ) . 'controls/toggle/toggle.css', null );
		}
	}
