 ...
 */
class Hoo_Control_Background extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		if ( class_exists( 'Hoo_Custom_Build' ) ) {
			...
			Hoo_Custom_Build::register_dependency( 'wp-color-picker' );
		}
		...
		if ( ! class_exists( 'Hoo_Custom_Build' ) || ! Hoo_Custom_Build::is_custom_build() ) {
			wp_enqueue_script( 'hoo-background', trailingslashit( Hoo::$url ) . 'controls/background/background.js', array( 'jquery', 'wp-color-picker-alpha' ) );
			wp_enqueue_style( 'hoo-background', trailingslashit( Hoo::$url ) . 'controls/background/background.css', null );
		}
	}
	...
	protected function content_template() {
		...
		<div class="background-wrapper">
			...
			<div class="background-color">
				...
				<input type="text" data-default-color="{{ data.default['background-color'] }}" data-alpha="true" value="{{ data.value['background-color'] }}" class="hoo-color-control"/>
			</div>
