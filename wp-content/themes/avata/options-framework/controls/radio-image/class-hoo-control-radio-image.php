 ...
 */
class Hoo_Control_Radio_Image extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		if ( ! class_exists( 'Hoo_Custom_Build' ) || ! Hoo_Custom_Build::is_custom_build() ) {
			wp_enqueue_script( 'hoo-radio-image', trailingslashit( Hoo::$url ) . 'controls/radio-image/radio-image.js', array( 'jquery', 'customize-base' ), false, true );
			wp_enqueue_style( 'hoo-radio-image-css', trailingslashit( Hoo::$url ) . 'controls/radio-image/radio-image.css', null );
		}
	}
