 ...
 */
class Hoo_Control_Slider extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		if ( ! class_exists( 'Hoo_Custom_Build' ) || ! Hoo_Custom_Build::is_custom_build() ) {
			wp_enqueue_script( 'hoo-slider', trailingslashit( Hoo::$url ) . 'controls/slider/slider.js', array( 'jquery', 'customize-base' ), false, true );
			wp_enqueue_style( 'hoo-slider-css', trailingslashit( Hoo::$url ) . 'controls/slider/slider.css', null );
		}
	}
	...
	protected function content_template() {
		...
		<label>
			...
			<div class="wrapper">
				...
				<div class="hoo_range_value">
					<span class="value">{{ data.value }}</span>
					<# if ( data.choices['suffix'] ) { #>
						{{ data.choices['suffix'] }}
					<# } #>
				</div>
				<div class="hoo-slider-reset">
