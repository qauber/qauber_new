wp.customize.controlConstructor['hoo-gradient'] = wp.customize.Control.extend({
	...
	initHooControl: function() {
		...
		var control      = this,
		    ...
		    pickerStart  = control.container.find( '.hoo-gradient-control-start' ),
		    pickerEnd    = control.container.find( '.hoo-gradient-control-end' ),
