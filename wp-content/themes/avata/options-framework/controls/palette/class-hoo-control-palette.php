 ...
 */
class Hoo_Control_Palette extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		if ( ! class_exists( 'Hoo_Custom_Build' ) || ! Hoo_Custom_Build::is_custom_build() ) {
			wp_enqueue_script( 'hoo-palette', trailingslashit( Hoo::$url ) . 'controls/palette/palette.js', array( 'jquery', 'customize-base', 'jquery-ui-button' ), false, true );
			wp_enqueue_style( 'hoo-palette-css', trailingslashit( Hoo::$url ) . 'controls/palette/palette.css', null );
		}
	}
