 ...
 */
class Hoo_Control_Dimension extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		if ( ! class_exists( 'Hoo_Custom_Build' ) || ! Hoo_Custom_Build::is_custom_build() ) {
			$script_to_localize = 'hoo-dimension';
			wp_enqueue_script( 'hoo-dimension', trailingslashit( Hoo::$url ) . 'controls/dimension/dimension.js', array( 'jquery', 'customize-base' ), false, true );
			wp_enqueue_style( 'hoo-dimension-css', trailingslashit( Hoo::$url ) . 'controls/dimension/dimension.css', null );
		}
