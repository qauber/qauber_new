 ...
 */
class Hoo_Control_Radio_Buttonset extends WP_Customize_Control {
	 ...
	 * @var string
	 */
	public $type = 'hoo-radio-buttonset';
	...
	public function enqueue() {
		...
		if ( ! class_exists( 'Hoo_Custom_Build' ) || ! Hoo_Custom_Build::is_custom_build() ) {
			wp_enqueue_script( 'hoo-radio-buttonset', trailingslashit( Hoo::$url ) . 'controls/radio-buttonset/radio-buttonset.js', array( 'jquery', 'customize-base' ), false, true );
			wp_enqueue_style( 'hoo-radio-buttonset-css', trailingslashit( Hoo::$url ) . 'controls/radio-buttonset/radio-buttonset.css', null );
		}
	}
