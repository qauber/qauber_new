...
$memberVisibility = array(
	...
	$member_params = array(
		...
		array(
			"type" 			=> "colorpicker",
			"heading" 		=> __( 'First Social color', 'member-vc' ),
			"param_name" 	=> "social_clr",
			"description" 	=> __( 'first color of social icon', 'member-vc' ),
			"group" 		=> 'Social',
		),
		...
		array(
			"type" 			=> "colorpicker",
			"heading" 		=> __( 'Second Social color', 'member-vc' ),
			"param_name" 	=> "social_clr2",
			"description" 	=> __( 'Second color of social icon', 'member-vc' ),
			"group" 		=> 'Social',
		),
		...
		array(
			"type" 			=> "colorpicker",
			"heading" 		=> __( 'Third Social color', 'member-vc' ),
			"param_name" 	=> "social_clr3",
			"description" 	=> __( 'Third color of social icon', 'member-vc' ),
			"group" 		=> 'Social',
		),
		...
		array(
			"type" 			=> "colorpicker",
			"heading" 		=> __( 'Fourth Social color', 'member-vc' ),
			"param_name" 	=> "social_clr4",
			"description" 	=> __( 'Fourth color of social icon', 'member-vc' ),
			"group" 		=> 'Social',
		),
		...
		array(
			"type" 			=> "colorpicker",
			"heading" 		=> __( 'Fifth Social color', 'member-vc' ),
			"param_name" 	=> "social_clr5",
			"description" 	=> __( 'Fifth color of social icon', 'member-vc' ),
			"group" 		=> 'Social',
		),
		...
		array(
			"type" 			=> "colorpicker",
			"heading" 		=> __( 'Sixth Social color', 'member-vc' ),
			"param_name" 	=> "social_clr6",
			"description" 	=> __( 'Sixth color of social icon', 'member-vc' ),
			"group" 		=> 'Social',
		),
    );
