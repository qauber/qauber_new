	...
	protected function content( $atts, $content = null ) {
		...
		<div style="text-align: <?php echo $align; ?>;">
			<?php if ($btn_style == 'animated' && $anim_style == 'transition') { ?>
				<a data-onhovercolor="<?php echo $btn_hvrclr; ?>" data-onhoverbg="<?php echo $btn_hvrbg; ?>" data-onleavebg="<?php echo $btn_bg; ?>" data-onleavecolor="<?php echo $btn_clr; ?>" href="<?php echo $btn_url; ?>" target="<?php echo $btn_next; ?>" class="mega_hvr_btn <?php echo $anim_trans; ?>" style="padding: <?php echo $padding_top; ?> <?php echo $padding_left; ?>; border:<?php echo $border_width; ?> solid <?php echo $btn_border; ?>; font-size: <?php echo $btn_size; ?>; color: <?php echo $btn_clr; ?>; background-color: <?php echo $btn_bg; ?>; border-radius: <?php echo $btn_radius; ?>">
			...
			<?php if ($btn_style == 'animated' && $anim_style == 'bg_transition') { ?>
				<a data-onhovercolor="<?php echo $btn_hvrclr; ?>" data-onleavecolor="<?php echo $btn_clr; ?>" href="<?php echo $btn_url; ?>" target="<?php echo $btn_next; ?>" style="padding: <?php echo $padding_top; ?> <?php echo $padding_left; ?>; border:<?php echo $border_width; ?> solid <?php echo $btn_border; ?>; font-size: <?php echo $btn_size; ?>; color: <?php echo $btn_clr; ?>; background-color: <?php echo $btn_bg; ?>; border-radius: <?php echo $btn_radius; ?>" class="mega_hvr_btn <?php echo $bg_trans; ?>">
			...
			<?php if ($btn_style == 'animated' && $anim_style == 'brdr_transition') { ?>
				<a data-onhovercolor="<?php echo $btn_hvrclr; ?>" data-onleavecolor="<?php echo $btn_clr; ?>" href="<?php echo $btn_url; ?>" target="<?php echo $btn_next; ?>" style="padding: <?php echo $padding_top; ?> <?php echo $padding_left; ?>; border:<?php echo $border_width; ?> solid <?php echo $btn_border; ?>; font-size: <?php echo $btn_size; ?>; color: <?php echo $btn_clr; ?>; background-color: <?php echo $btn_bg; ?>; border-radius: <?php echo $btn_radius; ?>" class="mega_hvr_btn <?php echo $brdr_trans; ?>">
					<span style="background: <?php echo $btn_hvrbg; ?>;"></span><i class="<?php echo $btn_icon; ?>"></i> <?php echo $btn_text; ?>
				</a>
			<?php } ?>
			...
			<?php if ($btn_style == 'animated' && $anim_style == 'shadow') { ?>
				<a data-onhovercolor="<?php echo $btn_hvrclr; ?>" data-onhoverbg="<?php echo $btn_hvrbg; ?>" data-onleavebg="<?php echo $btn_bg; ?>" data-onleavecolor="<?php echo $btn_clr; ?>" href="<?php echo $btn_url; ?>" target="<?php echo $btn_next; ?>" class="mega_hvr_btn <?php echo $shadow_trans; ?>" style="padding: <?php echo $padding_top; ?> <?php echo $padding_left; ?>; border:<?php echo $border_width; ?> solid <?php echo $btn_border; ?>; font-size: <?php echo $btn_size; ?>; color: <?php echo $btn_clr; ?>; background-color: <?php echo $btn_bg; ?>; border-radius: <?php echo $btn_radius; ?>">
					<i class="<?php echo $btn_icon; ?>"></i> <?php echo $btn_text; ?>
				</a>
			<?php } ?>
			...
			<?php if ($btn_style == 'animated' && $anim_style == 'speech_bubbles') { ?>
				<a data-onhovercolor="<?php echo $btn_hvrclr; ?>" data-onleavecolor="<?php echo $btn_clr; ?>" href="<?php echo $btn_url; ?>" target="<?php echo $btn_next; ?>" class="mega_hvr_btn <?php echo $bubble_trans; ?>" style="padding: <?php echo $padding_top; ?> <?php echo $padding_left; ?>; border:<?php echo $border_width; ?> solid <?php echo $btn_border; ?>; font-size: <?php echo $btn_size; ?>; color: <?php echo $btn_clr; ?>; background-color: <?php echo $btn_bg; ?>; border-radius: <?php echo $btn_radius; ?>">
					<span style="
			...
			<!-- 3D button -->
			<?php if ($btn_style == '3D') { ?>
				<a href="<?php echo $btn_url; ?>" class="push_button" target="<?php echo $btn_next; ?>" style="font-size: <?php echo $btn_size; ?>; padding: <?php echo $padding_top; ?> <?php echo $padding_left; ?>; background: <?php echo $btn_bg; ?>; color: <?php echo $btn_clr; ?>; box-shadow: 0 0 0 1px <?php echo $btn_shadow; ?> inset, 0 0 0 2px rgba(255,255,255,0.15) inset, 0 8px 0 0 <?php echo $btn_shadow; ?>, 0 8px 8px 1px rgba(0,0,0,0.5);">
					<i class="<?php echo $btn_icon; ?>"></i> <?php echo $btn_text; ?>
				</a>
			<?php } ?>
		</div>
...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			"description" 	=> __( 'It will increase height of button e.g 10px', 'button' ),
			"group" 		=> 'General',
		),
		array(
			"type" 			=> "textfield",
			...
			"description" 	=> __( 'It will increase width of button e.g 20px', 'button' ),
			"group" 		=> 'General',
		),
		array(
			"type" 			=> "textfield",
			...
			"description" 	=> __( 'set button radius e.g 5px', 'button' ),
			"dependency" => array('element' => "btn_style", 'value' => 'animated'),
			"group" 		=> 'General',
		),
		array(
		...
		array(
			...
			"param_name" 	=> "btn_size",
			"description" 	=> __( 'Set font size in pixel e.g 18px', 'button' ),
			"group" 		=> 'Text',
		),
		array(
			"type" 			=> "textfield",
		...
		array(
			...
			"description" 	=> __( 'Set width of border in pixel e.g 1px', 'button' ),
			"dependency" => array('element' => "btn_style", 'value' => 'animated'),
			"group" 		=> 'Border',
		),
