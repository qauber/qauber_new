...
if (!class_exists('tek_testimonials')) {
    class tek_testimonials extends KEYDESIGN_ADDON_CLASS
    {
        function __construct() {
            add_action('admin_init', array($this, 'kd_testimonials_init'));
        ...
        public function kd_testimonials_container($atts, $content = null) {
            ...
            $output .= '
            <div class="slider testimonials '.$kd_ttunique_id.' '.$tt_extra_class . $tt_image_layout.'">'.do_shortcode($content).'</div>';
        ...
        public function kd_testimonials_single($atts, $content = null) {
            ...
            $output = '<div class="tt-content '.$ttc_extra_class.'">
              <div class="container">
                ...
                <h3>'.$tt_heading.'</h3>
                <h6><span class="tt-quote"></span><span class="tt-quote tt-quote-right"></span>'.$tt_quote.'</h6>
