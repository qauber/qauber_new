...
if (!class_exists('KD_ELEM_PROGRESSBAR')) {
    ...
    class KD_ELEM_PROGRESSBAR extends KEYDESIGN_ADDON_CLASS {
        ...
        function __construct() {
            add_action('admin_init', array($this, 'kd_progressbar_init'));
                ...
                vc_map(array(
                    ...
                    "params" => array(
                       ...
                       array(
                           "type"			=>	"dropdown",
                           "class"			=>	"",
                           "heading"		=>	esc_html__("Icon source","keydesign"),
        ...
        public function kd_progressbar_shrt($atts, $content = null)
        {
            ...
            if( $pb_icon_type == 'icon_browser' && !empty($pb_icon_font) ) {
		            $content_icon = '<div class="kd-progress-icon"><i class="'.$pb_icon_font .' fa"></i></div>';
            }
