<?php
if(!class_exists('prime_Switch_Param'))
{
	class prime_Switch_Param
	{
		function __construct()
		{
			if(defined('WPB_VC_VERSION') && version_compare(WPB_VC_VERSION, 4.8) >= 0) {
				...
				{
					vc_add_shortcode_param('prime_switch' , array($this, 'checkbox_param'));
				}
			}
			else {
				if(function_exists('add_shortcode_param'))
				{
					add_shortcode_param('prime_switch' , array($this, 'checkbox_param'));
				}
			}
		}
