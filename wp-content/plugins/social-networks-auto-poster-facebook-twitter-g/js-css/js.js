...
function nxs_updateGetImgs(e){ var textOut=''; var tId = e.target.id;  var tIdN = tId.replace("isAutoImg-", "");
...
function nxs_actDeActTurnOff(objId){ if (jQuery('#'+objId).val()!='1') { jQuery('#'+objId+'xd').show(); jQuery('#rpstPostWhenFinished').show(); } else { jQuery('#'+objId+'xd').hide(); jQuery('#rpstPostWhenFinished').hide(); } }
...
function nxs_V4_filter_mainJS($){
    ...
    jQuery( '.nxs_add_meta_compare' ).on( 'click', function(e) { e.preventDefault();
       ...
       var ii = jQuery( this ).attr( "data-ii" ); var nt = jQuery( this ).attr( "data-nt" );  var count_compares = +jQuery( '#nxs_count_meta_'+nt+ii ).val( function( ii, val ) { return ( + val + 1 ); } ).val(); 
    ...
    jQuery( '.nxs_add_term_compare' ).on( 'click', function(e) { e.preventDefault(); var ii = jQuery( this ).attr( "data-ii" ); var nt = jQuery( this ).attr( "data-nt" );  var count_compares = +jQuery( '#nxs_count_term_'+nt+ii ).val( function( ii, val ) { return ( + val + 1 ); } ).val(); 
