...
**This plugin automatically publishes posts from your blog to your Social Media accounts** such as Facebook, Twitter, Google+(Google Plus), Blogger, Tumblr, Flickr, LiveJournal, Flipboard, Instagram, Telegram, DreamWidth, Delicious, Diigo, Instapaper, Stumbleupon, LinkedIn, ok.ru, Pinterest, Plurk, VK.com (VKontakte), YouTube, Scoop.It, Wordpress, XING etc. The whole process is completely automated. Just write a new post and either entire post or it's nicely formatted announcement with backlink will be published to all your configured social networks. You can reach the most audience and tell all your friends, readers and followers about your new post. Plugin works with profiles, business pages, community pages, groups, etc. Messages are 100% customizable and adopted for each network requirements.
...
* <a href="https://www.nextscripts.com/snap-features/filters/">Re-Poster</a>. Automatically psot your already existing posts to your social media accounts.
...
Yes, it can. Specify page in the "Where to Post" field in the accoint settings, and it will post to pages. 
...
* Bug Fix - Random reposter will wait for new posts when number of posts is 0, instead of stopping.
* Bug Fix - Random Reposter were always choosing the same post if WPML or some other plugins are installed.
