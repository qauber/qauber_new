...
public function load_resources(){
	...
	$otw_bm_factory_object->add_plugin( $otw_bml_plugin_id, __FILE__, array( 'menu_parent' => 'otw-bml', 'lc_name' => __( 'License Manager', 'otw_bml' ), 'menu_key' => 'otw-bml' ) );
  ...
  public function bm_meta_boxes () {
    ...
    add_meta_box(
      'otw-bm-meta-box', 
      __('OTW Media Item', OTW_BML_TRANSLATION), 
  ...
  public function saveAction() {
	...
	if( isset( $otw_bm_list_data['otw-bm-list'][ 'otw-bm-list-' . $_POST['id'] ]['categories'] ) && is_array( $otw_bm_list_data['otw-bm-list'][ 'otw-bm-list-' . $_POST['id'] ]['categories'] ) ){
	
		if( count( $otw_bm_list_data['otw-bm-list'][ 'otw-bm-list-' . $_POST['id'] ]['categories'] ) ){
			$otw_bm_list_data['otw-bm-list'][ 'otw-bm-list-' . $_POST['id'] ]['categories'] = implode( ',', $otw_bm_list_data['otw-bm-list'][ 'otw-bm-list-' . $_POST['id'] ]['categories'] );
		}else{
			$otw_bm_list_data['otw-bm-list'][ 'otw-bm-list-' . $_POST['id'] ]['categories'] = '';
		}
	}
	if( isset( $otw_bm_list_data['otw-bm-list'][ 'otw-bm-list-' . $_POST['id'] ]['tags'] ) && is_array( $otw_bm_list_data['otw-bm-list'][ 'otw-bm-list-' . $_POST['id'] ]['tags'] ) ){
	
		if( count( $otw_bm_list_data['otw-bm-list'][ 'otw-bm-list-' . $_POST['id'] ]['tags'] ) ){
			$otw_bm_list_data['otw-bm-list'][ 'otw-bm-list-' . $_POST['id'] ]['tags'] = implode( ',', $otw_bm_list_data['otw-bm-list'][ 'otw-bm-list-' . $_POST['id'] ]['tags'] );
		}else{
			$otw_bm_list_data['otw-bm-list'][ 'otw-bm-list-' . $_POST['id'] ]['tags'] = '';
		}
	}
	if( isset( $otw_bm_list_data['otw-bm-list'][ 'otw-bm-list-' . $_POST['id'] ]['users'] ) && is_array( $otw_bm_list_data['otw-bm-list'][ 'otw-bm-list-' . $_POST['id'] ]['users'] ) ){
	
		if( count( $otw_bm_list_data['otw-bm-list'][ 'otw-bm-list-' . $_POST['id'] ]['users'] ) ){
			$otw_bm_list_data['otw-bm-list'][ 'otw-bm-list-' . $_POST['id'] ]['users'] = implode( ',', $otw_bm_list_data['otw-bm-list'][ 'otw-bm-list-' . $_POST['id'] ]['users'] );
		}else{
			$otw_bm_list_data['otw-bm-list'][ 'otw-bm-list-' . $_POST['id'] ]['users'] = '';
		}
	}
      ...
      if( empty($this->errors) ) {
        ...
        $this->redirect('admin.php?page=otw-bml-add&action=edit&otw-bm-list-id='.$_POST['id'].'&success=true');
        exit;
  ...
  public function bml_settings () {
    ...
    if( !empty( $_POST ) ) {
      ...
      file_put_contents( $cssPath, $customCSS );
		...
		if( isset( $_POST['otw_bm_promotions'] ) && !empty( $_POST['otw_bm_promotions'] ) ){
			
			global $otw_bml_factory_object, $otw_bml_plugin_id;
			
			update_option( $otw_bml_plugin_id.'_dnms', $_POST['otw_bm_promotions'] );
