...
if ( ! class_exists( 'ASVC_EDD' ) ) {
    class ASVC_EDD {
        ...
        function ASVC_EDD() {
            ...
            function asvc_edd_shortcode_function( $atts, $content = null, $tag ) {
        ...
        $edd_id++;
            ...
            add_shortcode( 'asvc_edd', 'asvc_edd_shortcode_function' );
        ...
        add_filter( 'vc_autocomplete_zozo_vc_edd_list_include_downloads_callback', 'asvc_vc_edd_list_include_field_search', 10, 1 ); // Get suggestion(find). Must return an array
